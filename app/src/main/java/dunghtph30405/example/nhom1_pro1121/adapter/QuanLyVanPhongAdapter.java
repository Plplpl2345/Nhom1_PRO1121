...
public class QuanLyVanPhongAdapter extends RecyclerView.Adapter<QuanLyVanPhongAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.btn_delete.setOnClickListener(v -> {
            ...
            builder.setPositiveButton("YES", (dialog, which) -> {
                boolean check = sanPhamDAO.deleteVP(product.getMasp());
                if (check) {
                    loadData();
    ...
    public void loadData() {
        list.clear();
        list.addAll(sanPhamDAO.selectMACBOOK());
        ...
        builder.setNegativeButton("Cập Nhật", (dialog, which) -> {
            try {
                ...
                if (tensp_ud.isEmpty() || giaText.isEmpty() || thuonghieu_ud.isEmpty() ||
                    ...
                    boolean check = sanPhamDAO.updateVP(masp, tensp_ud, giasp_ud, thuonghieu_ud,
